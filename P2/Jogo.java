...
public class Jogo {
    ...
    public Jogo(Jogador jogador1, Jogador jogador2, Jogador jogador3){
    ...
    public void rodada(int numero1, int numero2, int numero3){
        ...
        && jogador1.getNumeroDaRodada() < jogador3.getNumeroDaRodada()) {
            rodada++;
            jogador1.incrementarEscore(10);
        }

        if (jogador1.getNumeroDaRodada() > jogador3.getNumeroDaRodada()
        && jogador1.getNumeroDaRodada() < jogador2.getNumeroDaRodada()) {
            rodada++;
            jogador1.incrementarEscore(10);
        }
        ...
        if (jogador2.getNumeroDaRodada() > jogador3.getNumeroDaRodada()
                && jogador2.getNumeroDaRodada() < jogador1.getNumeroDaRodada()) {
            rodada++;
            jogador2.incrementarEscore(10);
        }

        //incrementando pontuação vencedor rodada
        if (jogador3.getNumeroDaRodada() > jogador1.getNumeroDaRodada()
                && jogador3.getNumeroDaRodada() < jogador2.getNumeroDaRodada()) {
            rodada++;
            jogador3.incrementarEscore(10);
        }

        if (jogador3.getNumeroDaRodada() > jogador2.getNumeroDaRodada()
